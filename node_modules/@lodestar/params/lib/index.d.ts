 ...
 * ```
 */
export declare const CURRENT_SYNC_COMMITTEE_GINDEX = 54;
/**
 * ```ts
 * Math.floor(Math.log2(CURRENT_SYNC_COMMITTEE_GINDEX))
 * ```
 */
export declare const CURRENT_SYNC_COMMITTEE_DEPTH = 5;
export declare const CURRENT_SYNC_COMMITTEE_INDEX = 22;
/**
 * ```ts
...
export declare const CURRENT_SYNC_COMMITTEE_GINDEX_ELECTRA = 86;
export declare const CURRENT_SYNC_COMMITTEE_DEPTH_ELECTRA = 6;
export declare const CURRENT_SYNC_COMMITTEE_INDEX_ELECTRA = 22;
